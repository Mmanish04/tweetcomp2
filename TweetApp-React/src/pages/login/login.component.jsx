...
export default function Login(props) {
    ...
    return (
        <>
            <div className={"d-flex h-100 justify-content-right align-items-right"}>
            <img
            src="https://static1.anpoimages.com/wordpress/wp-content/uploads/2022/05/Twitter-generic-hero-whats-happening.jpg"
            height={585} width={750}
          />
                <div style={{ width: "28%", maxWidth: 400 , marginLeft: 70 }}>
                    <div>
                        <img src={imgLogo} height={150} width={150} />
                    </div>
                    <div>
                        <h2 style={{ fontFamily: "Barlow-Bold", marginBottom: 20 }}>Sign in to Tweet App</h2>
                    </div>
